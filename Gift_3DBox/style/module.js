...
// === Overlay ảnh thay cho chữ Merry Christmas ===
const overlayTexture = new THREE.TextureLoader().load('../img/hb.png') // ảnh bạn muốn đè lên
...
// Tạo mặt phẳng chứa ảnh overlay
const overlayPlane = new THREE.Mesh(
  new THREE.PlaneGeometry(4.3, 1.6), // tỉ lệ gần giống dòng chữ gốc
  overlayMaterial
)

// Canh chính xác vị trí chỗ chữ “Merry Christmas”
overlayPlane.position.set(1.5, 1.0, -1.7)  // X, Y, Z — vị trí khớp chữ
overlayPlane.rotation.y = -Math.PI / 5.5   // nghiêng nhẹ theo tường
overlayPlane.rotation.x = 0
overlayPlane.rotation.z = 0
